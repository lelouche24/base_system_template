...
<div class="row" style="font-size: 11px !important;">
    ...
    <div class="col-12 col-sm-4 mb-2">
        ...
        <input type="password" class="form-control rounded-0" name="password" id="password" autocomplete="off" placeholder="Password" required>
    </div>
    <div class="col-12 col-sm-4 mb-2">
        <label class="fw-bold">Confirm password<span class="text-danger"> *</span></label>
        <input type="password" class="form-control rounded-0" name="password_confirmation" id="password_confirmation" autocomplete="off" placeholder="Confirm password" required>
    </div>
</div>